...
namespace client.Menus
{
    internal class Player : Drawing
    {
        ...
        public static async Task Draw()
        {
            ...
            var d = AddBool("Drunk?", ref isDrunk);
            ...
            if (IsEntryPressed(d))
            {
                Debug.WriteLine($"SET_ENTITY_ISDRUNK to {isDrunk} for me ({pedId})");
                Function.Call(Hash.SET_PED_IS_DRUNK, pedId, isDrunk);
            }
